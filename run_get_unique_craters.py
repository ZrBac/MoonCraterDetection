...
CP['dir_model'] = '/home/partition1/MoonCraterData/model/res_6_model.h5'

# Location of where hdf5 data images are stored
CP['dir_data'] = '/home/partition1/MoonCraterData/%s_images.hdf5' % CP['datatype']

# Location of where model predictions are/will be stored
CP['dir_preds'] = '/home/partition1/MoonCraterData/catalogues/res_6_%s_preds_n%d.hdf5' % (CP['datatype'],
                                                    CP['n_imgs'])

# Location of where final unique crater distribution will be stored
CP['dir_result'] = '/home/partition1/MoonCraterData/catalogues/res_6_%s_craterdist.npy' % (CP['datatype'])
