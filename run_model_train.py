...
MP['dir'] = '/home/partition1/MoonCraterData/'
...
MP['save_models'] = 1
MP['save_dir'] = '/home/partition1/MoonCraterData/model/model.h5'

# Model Parameters (to potentially iterate over, keep in lists).
MP['N_runs'] = 1                # Number of runs
MP['filter_length'] = [3]       # Filter length
MP['lr'] = [0.0004]             # Learning rate
MP['n_filters'] = [32]         # Number of filters
